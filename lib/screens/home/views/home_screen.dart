          ...
          Scaffold(
            ...
            bottomNavigationBar: ClipRRect(
              ...
              child: BottomNavigationBar(
                  ...
                  elevation: 3,
                  items: [BottomNavigationBarItem(icon: Icon(CupertinoIcons.home, color: index == 0 ? selectedItem : unselectedItem), label: 'Home'),
                       BottomNavigationBarItem(icon: Icon(CupertinoIcons.graph_square_fill, color: index == 1 ? selectedItem : unselectedItem), label: 'Stats')]),
            ),
             // the plus icon
                  ...
                  MaterialPageRoute<Expense>(
                    ...
                    MultiBlocProvider(
                      providers: [
                        ...
                        BlocProvider(create: (context)=> DeleteCatagoryBloc(FirebaseExpenseRepo()))
